...
- добавлены шаблоны переименования файлов (теги формата `zoneN`)
- включение/выключение сбора распознанных через ocr областей (`ocr_storage`) теперь в настройках (не по умолчанию)
